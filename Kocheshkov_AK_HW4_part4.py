class MansPocket(): #Самая вместительная вещь!
    def __init__(self, inventory = {}, carryweight = 0, maxweight = 70): #Создание единицы класса. По дефолту создаёт объект с пустым инвентарём, который ничего не весит, и задаёт максимальный переносимый вес
    ...
    def additem(self, item, weight): #Для добавления предмета в инвентарь
        if (self.carryweight < self.maxweight) and ((self.carryweight + weight) <= self.maxweight): #Проверка на вес
...
gameitemskeys = ["Утигатана","Реки крови","Лунная вуаль","Шлем из Страны тростника","Доспех из Страны тростника",
    "Перчатки из Страны тростника","Поножи из Страны тростника","Фляга с чудесным снадобьем","Фляга багровых слёз","Фляга лазурных слёз",
    "Костяной свисток","Шлем Рыжей Гривы","Львиный доспех Радана","Перчатки Радана","Поножи Радана"]
